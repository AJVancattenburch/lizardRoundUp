...
public class Startup
{
  ...
  public void ConfigureServices(IServiceCollection services)
  {
    ...
    {
      c.SwaggerDoc("v1", new OpenApiInfo { Title = "lizardRoundUp", Version = "v1" });
    });
    ...
    services.AddSingleton<LizardsRepository>();
    services.AddTransient<LizardsService>();
  }
